#ifndef ESP_LSM9DS0_TCP_H
#define ESP_LSM9DS0_TCP_H
...
#include <ESPSensorTCP.h>
// I2C setup 
// SDO_XM and SDO_G are both pulled high, so our addresses are:
#define LSM9DS1_M  0x1E // Would be 0x1C if SDO_M is LOW
#define LSM9DS1_AG  0x6B // Would be 0x6A if SDO_AG is LOW

#define MAX_IMU_BUFF_SIZE 256
...
#define DEFAULT_ACC_SAMPLERATE 3 //119Hz
#define DEFAULT_GYRO_SAMPLERATE 3 //119Hz
#define DEFAULT_MAG_SAMPLERATE 7 //80Hz
...
class ESP_LSM9DS1: public ESPSensor{
  public:
    ...
    //IMUDatagram imuData;
		IMUData *data;    
		unsigned char imuStream[MAX_IMU_BUFF_SIZE*sizeof(IMUData)+HEADER_SIZE+FOOTER_SIZE];
